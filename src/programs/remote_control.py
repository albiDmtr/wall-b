    ...
    if key_event.type == ecodes.EV_KEY:
        ...
        if key_event.keystate == key_event.key_down:
            if key_event.keycode == 'KEY_LEFT':
                ...
                GPIO.output(left_wheel_pin_back, GPIO.HIGH)
                GPIO.output(right_wheel_pin_back, GPIO.HIGH)
